...
const CITIES = [
    ...
    { name: "Москва", lat: 55.7558, lon: 37.6173, region: "europe" }, { name: "Санкт-Петербург", lat: 59.9343, lon: 30.3351, region: "europe" },
    { name: "Екатеринбург", lat: 56.8389, lon: 60.6057, region: "europe" }, { name: "Казань", lat: 55.7963, lon: 49.1088, region: "europe" },
    { name: "Минск", lat: 53.9006, lon: 27.5590, region: "europe" }, { name: "Барселона", lat: 41.3851, lon: 2.1734, region: "europe" }, 
    { name: "Милан", lat: 45.4642, lon: 9.1900, region: "europe" }, { name: "Мюнхен", lat: 48.1351, lon: 11.5820, region: "europe" }, 
    { name: "Киев", lat: 50.4501, lon: 30.5234, region: "europe" }, { name: "Осло", lat: 59.9139, lon: 10.7522, region: "europe" },
    ...
    { name: "Мумбаи", lat: 19.0760, lon: 72.8777, region: "asia" }, { name: "Дубай", lat: 25.2048, lon: 55.2708, region: "asia" }, 
    { name: "Эр-Рияд", lat: 24.7136, lon: 46.6753, region: "asia" }, { name: "Тель-Авив", lat: 32.0853, lon: 34.7818, region: "asia" }, 
    { name: "Тайбэй", lat: 25.0330, lon: 121.5654, region: "asia" }, { name: "Ташкент", lat: 41.2995, lon: 69.2401, region: "asia" }, 
    { name: "Астана", lat: 51.1694, lon: 71.4491, region: "asia" }, { name: "Алматы", lat: 43.2220, lon: 76.8512, region: "asia" },
    { name: "Новосибирск", lat: 55.0084, lon: 82.9357, region: "asia" }, { name: "Стамбул", lat: 41.0082, lon: 28.9784, region: "asia" },
    { name: "Баку", lat: 40.4093, lon: 49.8671, region: "asia" }, { name: "Тбилиси", lat: 41.7151, lon: 44.8271, region: "asia" },

    // 🗽 СЕВЕРНАЯ АМЕРИКА
    { name: "Нью-Йорк", lat: 40.7128, lon: -74.0060, region: "north_america" }, { name: "Лос-Анджелес", lat: 34.0522, lon: -118.2437, region: "north_america" },
    { name: "Чикаго", lat: 41.8781, lon: -87.6298, region: "north_america" }, { name: "Торонто", lat: 43.6510, lon: -79.3470, region: "north_america" },
    { name: "Мехико", lat: 19.4326, lon: -99.1332, region: "north_america" }, { name: "Сан-Франциско", lat: 37.7749, lon: -122.4194, region: "north_america" },
    { name: "Сиэтл", lat: 47.6062, lon: -122.3321, region: "north_america" }, { name: "Вашингтон", lat: 38.9072, lon: -77.0369, region: "north_america" },
    ...
    { name: "Йоханнесбург", lat: -26.2041, lon: 28.0473, region: "africa" }, { name: "Претория", lat: -25.7479, lon: 28.2293, region: "africa" }, 
